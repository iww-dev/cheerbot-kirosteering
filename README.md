...
Steering rules for [Kiro IDE](https://kiro.dev) that make Claude AI more ChatGPT-like. Modern, fast, friendly, and straight to the point.
...
A friendlier fork of [chatbottify-kirosteering](https://github.com/warwakei/chatbottify-kirosteering) by the same author. Set of steering rules that change how Claude behaves in Kiro:
...
1. Download `CheerbotInstaller.exe` from [Releases](https://github.com/warwakei/cheerbot-kirosteering/releases)
2. Run the installer
